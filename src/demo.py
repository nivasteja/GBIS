...
ACTIONS_GESTURE_ENCODING = {'fist': 'Play/Unpause', 'five': 'Pause', 'none': 'Do Nothing', 'okay': 'Increase Volume',
                            'peace': 'Decrease Volume', 'rad': "Load Song", 'straight': "Stop", "thumbs": "NA"}
...
def drawSideFrame(historic_predictions, frame, modelName, label):
    ...
    if GESTUREMODE:
        ...
        cv2.putText(score_frame, f'Action : {ACTIONS_GESTURE_ENCODING[GESTURE_ENCODING[label]]}', (20, 150), FONT, 0.55,
                    (0, 0, 0), 2, cv2.LINE_AA)
    ...
    if bgModel:
        ...
        while True:
            ...
            if DATAMODE:
                ...
                cv2.putText(new_frame, f"{NUMBERTOCAPTURE} {WHERE} images", (980, 400), FONT, 0.6, (0, 0, 0), 2,
                            cv2.LINE_AA)
